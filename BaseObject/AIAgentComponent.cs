...
public class AIAgentComponent : MonoBehaviour {
	...
	public void ParsePawn (Pawn controlledPawn)
	{
		...
		size = Mathf.Sqrt(charController.Radius*charController.Radius +charController.height/2*charController.height/2)
	...
	public void MovePawn(){
		charController.Move(resultTranslate);
		myTransform.rotation=resultRotation;
	}
